...
upgrades["inventory1"] = {
    ...
    previous: "speed2",
    unlocked: false,
    function: "increaseInventory(game)",
    costgray: 1,
    costyellow: 0,
    costblue: 0,
...
upgrades["hp4"] = {
    ...
    costyellow: 2,
    costblue: 0,
    description: "Further inceases health.",
};
upgrades["regen1"] = {
    name: "Regeneration",
    id: "regen1",
    ...
    costyellow: 2,
    costblue: 0,
    description: "Slowly regenerates health when walking.",
};
upgrades["regen2"] = {
...
upgrades["coffin"] = {
    ...
    costblue: 0,
    description:
        "Because you might not make it out alive. Comes with a budget tombstone. (Reduces knockout damage)",
};
upgrades["coffin2"] = {
...
upgrades["timer4"] = {
    ...
    costyellow: 2,
    costblue: 0,
    description: "Increases time limit further.",
};
upgrades["timer5"] = {
